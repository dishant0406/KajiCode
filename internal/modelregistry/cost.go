...
func (registry Registry) EstimateCost(pattern string, usage kajicoderuntime.Usage) (CostBreakdown, error) {
...
func CalculateCost(model ModelEntry, usage kajicoderuntime.Usage) (CostBreakdown, error) {
