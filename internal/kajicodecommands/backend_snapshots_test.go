...
func TestPluginSnapshotFromPluginCollapsesSlicesToCounts(t *testing.T) {
	plugin := plugins.LoadedPlugin{
		...
		Root:         "  /home/user/.config/kajicode/plugins/example  ",
		PluginDir:    "  /home/user/.config/kajicode/plugins/example/v1  ",
		ManifestPath: "  /home/user/.config/kajicode/plugins/example/v1/manifest.json  ",
